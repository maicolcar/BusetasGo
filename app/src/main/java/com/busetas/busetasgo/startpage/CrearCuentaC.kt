...
class CrearCuentaC : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_crear_cuenta_c)
        ...
        val nombreC = findViewById<AppCompatEditText>(R.id.nombreC)
        val correoC = findViewById<AppCompatEditText>(R.id.correoC)
        val passwordC = findViewById<AppCompatEditText>(R.id.passwordC)
        val spinnerDia: Spinner = findViewById(R.id.diaC)
        val spinnerMes: Spinner = findViewById(R.id.mesC)
        val spinnerYear: Spinner = findViewById(R.id.yearC)
        ...
        val registrarC = findViewById<AppCompatButton>(R.id.registrarC)
        registrarC.setOnClickListener {
            val nombre = nombreC.text.toString()
            val email = correoC.text.toString()
